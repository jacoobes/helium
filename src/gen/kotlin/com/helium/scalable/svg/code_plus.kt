...
// _0_3
            ...
            generalPath?.run {
                moveTo(6.0f, 19.0f)
                cubicTo(4.8954306f, 19.0f, 4.0f, 18.10457f, 4.0f, 17.0f)
                lineTo(4.0f, 13.0f)
                lineTo(3.0f, 12.0f)
                lineTo(4.0f, 11.0f)
                lineTo(4.0f, 7.0f)
                cubicTo(4.0f, 5.8954306f, 4.8954306f, 5.0f, 6.0f, 5.0f)
            }
            shape = Outline.Generic(generalPath!!)
            drawOutline(outline = shape!!, style = stroke!!, brush = brush!!, alpha = alpha, blendMode = blendMode)
            alpha = alphaStack.removeAt(0)
...
// _0_4
            ...
            generalPath?.run {
                moveTo(18.0f, 19.0f)
                cubicTo(19.10457f, 19.0f, 20.0f, 18.10457f, 20.0f, 17.0f)
                lineTo(20.0f, 13.0f)
                lineTo(21.0f, 12.0f)
                lineTo(20.0f, 11.0f)
                lineTo(20.0f, 7.0f)
                cubicTo(20.0f, 5.8954306f, 19.10457f, 5.0f, 18.0f, 5.0f)
            }
            shape = Outline.Generic(generalPath!!)
            drawOutline(outline = shape!!, style = stroke!!, brush = brush!!, alpha = alpha, blendMode = blendMode)
            alpha = alphaStack.removeAt(0)
